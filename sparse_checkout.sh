...
git_folder_location='c:/Users/mihessel/Source/repos'   #replace with the local root folder location where you want to create the project folder
project_name=mlops-test   #replace with your project name
github_org_name=mihessel01   #replace with your github org name
